...
const StaffViewTicket = ({ match, status }) => {
      ...
      .then(response => {
        ...
        setTicketAssigned(
          response.data.assigneduser
            ? response.data.assigneduser.username
            : "Nobody"
        );
      });
  ...
  const unassign = () => {
    axiosWithAuth()
      .put(`/tickets/ticket/unassign/${id}`)
      ...
      <Grid.Row>
        <Grid.Column width={3}>
          <Segment raised>
            ...
            <p>
              <strong>Assigned:</strong> {ticketAssigned}
            </p>
            <Label.Group>
        ...
        <Grid.Column width={13}>
          <Segment>
            ...
            <p>
              <strong>Attempted:</strong> {ticket.tried}
            </p>
          </Segment>
          <Comment.Group>
