...
const StaffDashboard = props => {
  return (
    <div>
      <Router>
        <Menu pointing>
          <Menu.Item href="/staff/dashboard" name="claimed tickets" />
          <Menu.Item
            href="/staff/dashboard/unclaimed_tickets"
            name="unclaimed tickets"
          />
          <Menu.Item href="/staff/dashboard/ticket_view" name="ticket view" />
        </Menu>
        <>
          <Switch>
            <Route exact path="/staff/dashboard" component={ClaimedTickets} />
            <Route
              path="/staff/dashboard/unclaimed_tickets"
              component={UnclaimedTickets}
            />
