...
export const SET_PROMOTING_USER = "SET_PROMOTING_USER";
export const SET_PROMOTED_USER = "SET_PROMOTED_USER";
export const SET_PROMOTED_USER_FAIL = "SET_PROMOTED_USER_FAIL";
export const SET_PROMOTING_USER_MODAL_OPEN = "SET_PROMOTING_USER_MODAL_OPEN";
export const UPDATE_USERS_AFTER_PROMOTION = "UPDATE_USERS_AFTER_PROMOTION";
...
export const CLAIM_TICKET = "CLAIM_TICKET";
